...
% 1?12 0 && 13:24 1
    ...
    for i = 1: max(trainset.feature13)
        for j = 1:trainlength
            for k = 1:length(DEGREE)
                if trainset.feature13(j) == i && trainset.label(j) == DEGREE(k)
    ...
    for i = 1:max(trainset.feature14)
        for j = 1: trainlength
            for k = 1: length(DEGREE)
                if trainset.feature14(j) ==i && trainset.label(j) == DEGREE(k)
    ...
    for i = 1:max(trainset.feature15)
        for j = 1 : trainlength
            for k = 1:length(DEGREE)
                if trainset.feature15(j) == i && trainset.label(j) == DEGREE(k)
    ...
    for i = 1:max(trainset.feature16)
        for j = 1:trainlength
            for k = 1:length(DEGREE)
                if trainset.feature16(j) ==i  && trainset.label(j) == DEGREE(k)
    ...
    for i = 1:max(trainset.feature17)
        for j = 1:trainlength
            for k = 1:length(DEGREE)
                if trainset.feature17(j) == i && trainset.label(j) == DEGREE(k)
    ...
    for i = 1: max(trainset.feature18)
        for j = 1:trainlength
            for k = 1:length(DEGREE)
                if trainset.feature18(j) == i && trainset.label(j) == DEGREE(k)
    ...
    for i = 1:max(trainset.feature19)
        for j = 1:trainlength
            for k = 1:length(DEGREE)
                if trainset.feature19(j) == i && trainset.label(j) == DEGREE(k)
    ...
    for i = 1:max(trainset.feature20)
        for j = 1:trainlength
            for k = 1:length(DEGREE)
                if trainset.feature20(j) == i && trainset.label(j) == DEGREE(k)
    ...
    for i = 1:max(trainset.feature21)
        for j = 1:trainlength
            for k = 1:length(DEGREE)
                if trainset.feature21(j) == i && trainset.label(j) == DEGREE(k)
    ...
    for i = 1:max(trainset.feature22)
        for j = 1:trainlength
            for k = 1 : length(DEGREE)
                if trainset.feature22(j) == i && trainset.label(j) == DEGREE(k)
    ...
    for i = 1: max(trainset.feature23)
       for j=  1:trainlength
            for k = 1:length(DEGREE)
                if trainset.feature23(j) == i && trainset.label(j) == DEGREE(k)
    ...
    for i = 1 :max(trainset.feature24)
        for j = 1:trainlength
            for k = 1:length(DEGREE)
                if trainset.feature24(j) == i && trainset.label(j) == DEGREE(k)
